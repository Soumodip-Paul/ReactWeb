...
export const Pricing = () => {
    const darkMode = React.useContext(Darkmode).mode
    const backGround = `bg-${darkMode ? "secondary" : "white"}`
    const textColor = `text-${darkMode ? "light" : "dark"}`
    return (
        <div className={`${backGround} ${textColor} container py-3`}>
                ...
                <div className="row row-cols-1 row-cols-md-3 mb-3 text-center">
                    <div className="col">
                        <div className="card mb-4 rounded-3 shadow-sm">
                            <div className={`card-header py-3 ${darkMode && 'bg-secondary'}`}>
                    ...
                    <table className="table text-center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><svg className="bi" width="24" height="24"><use xlinkHref={`${Img}#check-circle-fill`} /></svg></td>
                                <td><svg className="bi" width="24" height="24"><use xlinkHref={`${Img}#check-circle-fill`} /></svg></td>
                                <td><svg className="bi" width="24" height="24"><use xlinkHref={`${Img}#check-circle-fill`} /></svg></td>
                            </tr>
                            <tr>
